 ...
 */
contract BancorFormula is ProtocolConstants, Power {
     ...
     *
     * Formula:
     * Return = _supply * ((1 + _depositAmount / _reserveBalance) ^ (_reserveRatio / _MAX_RESERVE_RATIO) - 1)
     *
    ...
    function calculatePurchaseReturn(
        ...
        if (_reserveRatio == _MAX_RESERVE_RATIO) {
     ...
     *
     * Formula:
     * Return = _reserveBalance * (1 - (1 - _sellAmount / _supply) ^ (1 / (_reserveRatio / _MAX_RESERVE_RATIO)))
     *
     * @param _supply              continuous token total supply
     * @param _reserveBalance    total reserve token balance
